...
payload = {
    ...
    DurationSet1 DurationSet2 DurationSet3 NoRound NoTournament NoPlayerA1 NoPlayerA2 NoPlayerB1 NoPlayerB2 No Version'></Request>"
}
...
if response.status_code == 200:
    ...
    with open("BeachMatchList.xml", "w", encoding="UTF-8") as file:
