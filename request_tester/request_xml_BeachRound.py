...
#--------------------------------------------------------------------------------------------------------------------------------
# Diese Datei dient zum Auswerten des XML-Requests für die BeachTeamList.
# Die BeachTeam Liste wird benötigt um die BeachTeams in der Datenbank zu speichern
...
if response.status_code == 200:
    ...
    with open("BeachRoundList.xml", "w", encoding="UTF-8") as file:
