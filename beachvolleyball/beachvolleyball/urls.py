"""
URL configuration for beachvolleyball project.
...
urlpatterns = [
    ...
    path('', include(('beachvolleyball_webapp.urls', 'beachvolleyball_webapp'), namespace = 'beachvolleyball_webapp')), # webapp views verknuepfen
